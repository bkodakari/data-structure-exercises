...
def unique_houses(filename):
    ...
    """
    harry_potter_info = open(filename)

    unique_house_token = set()

    for line in harry_potter_info:
        data_lines = line.split("|")
        house_token = data_lines[2]
        unique_house_token = house_token
    # houses = set([house[2] for house in data_lines])

    # Code goes here

    return unique_house_token
